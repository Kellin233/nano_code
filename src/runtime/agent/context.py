...
from ...domains.memory.retrieval import MemoryPrefetch, start_memory_prefetch
from ...domains.memory.rendering import format_memories_for_injection
from ...domains.memory.store import mark_accessed
...
class AgentContextMixin:
    ...
    def _prepare_initial_context_attachments(self) -> None:
        ...
        if not self.is_sub_agent:
            try:
                from ...domains.context.attachments import render_skill_listing_attachment
        ...
        try:
            from ...domains.context.attachments import render_deferred_tools_attachment
