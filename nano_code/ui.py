...
def print_welcome() -> None:
    console.print("\n  [bold cyan]Nano Code[/bold cyan][dim] — A lightweight coding agent[/dim]\n")
    console.print("[dim]  Type your request, or 'exit' to quit.[/dim]")
    console.print("[dim]  Commands: /clear /cost /compact /memory /skills[/dim]\n")
...
def print_sub_agent_start(agent_type: str, description: str) -> None:
    # 子智能体内部的流式正文会被 buffer 收集；终端只显示开始/结束边界，
    # 让用户知道主 Agent 正在等待哪个独立任务。
